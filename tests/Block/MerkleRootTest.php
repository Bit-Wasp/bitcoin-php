...
class MerkleRootTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateNew()
    {
        ...
        $root = new MerkleRoot($this->math, $block);
    ...
    public function testCustomHashFunction()
    {
        ...
        $root = new MerkleRoot($this->math, $block, $hasher);
    ...
    public function testWithOnlyOneTransaction()
    {
        ...
        $this->assertSame($tx->getTransactionId(), $hash);
    }
    ...
    public function testWithOnlyEvenNumberOfTransactions()
    {
        ...
        $tx1 = new Transaction;
        $tx1 = $tx1->fromHex($hex1);
        $this->assertSame($hex1, $tx1->serialize('hex'));
        ...
        $tx2 = new Transaction;
        $tx2 = $tx2->fromHex($hex2);
        $this->assertSame($hex2, $tx2->serialize('hex'));
        ...
        $hash = $root->calculateHash();
        $this->assertSame('e22e7f473e3c50e2a5eab4ee1bc1bd8bb6d21a5485542ccebbda9282bb75491f', $hash);
    ...
    public function testWithOnlyOddNumberOfTransactions()
    {
        $transactions = array_map(
            function($value) {
                return (new Transaction)->fromHex($value);
            },
        ...
        $hash = $root->calculateHash();
        $this->assertSame('cb59c3f584d7fd3d391b56674c00830d0c33c164a44ab25df88ba8547c6355cb', $hash);

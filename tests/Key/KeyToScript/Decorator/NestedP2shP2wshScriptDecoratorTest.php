...
use BitWasp\Bitcoin\Key\KeyToScript\Decorator\NestedP2shP2wshScriptDecorator;
...
class NestedP2shP2wshScriptDecoratorTest extends AbstractTestCase
{
    ...
    {
        $p2shFactory = new NestedP2shP2wshScriptDecorator($factory);
    ...
    public function testNotAllowed()
    {
        ...
        new NestedP2shP2wshScriptDecorator(new P2wpkhScriptDataFactory());
    }
}
